...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2022 at 01:53 PM
...
(47, 217, 15, '2022-06-11'),
(48, 218, 16, '2022-06-11');
...
(180, 590, 15, 2, 155, 'Fontis 5 Gallon Mineral Water(non-refill)', 'Refreshing natural mineral water in a round container best used for water dispensers.', 2, '2131230972', '217', 'not delivered'),
(181, 591, 15, 1, 35, 'Fontis 5 Gallon Mineral Water(refill)', 'Refreshing natural mineral water in a round container best used for water dispensers.', 3, '2131230972', '217', 'not delivered'),
(182, 592, 15, 15, 75, 'Fontis 5 liter Purified Water', 'Portable purified water container for quick thirst quencher and refreshment.', 1, '2131230968', '217', 'not delivered'),
(183, 593, 15, 16, 210, '3 pack Fontis 5 liter Purified Water', 'If one is not enough, add more refreshing purified water for quick thirst quencher and refreshment.', 1, '2131230969', '217', 'not delivered'),
(184, 594, 15, 18, 169, 'Fontis 24 ounce Stainless Steel Bottle', 'Get your own insulated bottle to store your favorite beverage for free on every ₱ 399 worth of purchase or get this item for ₱ 169.', 2, '2131230971', '217', 'not delivered'),
(185, 595, 16, 5, 68, 'Fontis 5 liter Mineral Water', 'Portable water container for quick thirst quencher and refreshment.', 1, '2131230975', '218', 'not delivered'),
(186, 596, 16, 18, 169, 'Fontis 24 ounce Stainless Steel Bottle', 'Get your own insulated bottle to store your favorite beverage for free on every ₱ 399 worth of purchase or get this item for ₱ 169.', 5, '2131230971', '218', 'not delivered'),
(187, 597, 16, 17, 30, 'Fontis 16 ounce infused Water', 'A refreshing and healthy twist to your good old thirst quencher.(comes in different flavors: lime, strawberry, apple, kiwi, cucumber & peach)', 1, '2131230970', '218', 'not delivered'),
(188, 598, 15, 2, 155, 'Fontis 5 Gallon Mineral Water(non-refill)', 'Refreshing natural mineral water in a round container best used for water dispensers.', 3, '2131230972', '219', 'not delivered'),
(189, 599, 15, 12, 165, 'Fontis 5 Gallon Purified Water(non-refill)', 'Purified refreshment in a round container best used for water dispensers.', 2, '2131230965', '219', 'not delivered'),
(190, 600, 15, 18, 169, 'Fontis 24 ounce Stainless Steel Bottle', 'Get your own insulated bottle to store your favorite beverage for free on every ₱ 399 worth of purchase or get this item for ₱ 169.', 1, '2131230971', '219', 'not delivered');
...
(217, 15, 1038, '2022-06-11', 9, '2131165281', 'true'),
(218, 16, 943, '2022-06-11', 7, '2131165281', 'true'),
(219, 15, 964, '2022-06-11', 6, '2131165281', 'false');
...
(15, 'Legendary', '035c38b95750ab68cc7544f3f821e7f1', 'Charizard', 'Pokemon', '09653294781', 'Brgy. Concepcion San Pablo City Laguna', '1996-11-23', 'charizard6969@gmail.com', 'Unemployed', 'Single', 'I\'m going to be a long day for me to know if you need anything let me know if you need anything let me know if you need anything'),
(16, 'Ben', '035c38b95750ab68cc7544f3f821e7f1', 'Benedicto', 'Lucido Jr.', '09369733382', '3487 Gracia St. Pinagkaisahan Makati City Philippines', '2020-06-13', 'benedictlucido69@gmail.com', 'Employed', 'Married', 'because I mean I don\'t know what to do about it and I love you too much dapat ginagalang ko safe and sound like a good time to come over and watch the'),
...
--
ALTER TABLE `fontis_useradminbreakdown`
  MODIFY `admin_breakdownID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=298;

--
-- AUTO_INCREMENT for table `fontis_useradminhistory`
--
ALTER TABLE `fontis_useradminhistory`
  MODIFY `admin_historyID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT for table `fontis_useradminorders`
--
ALTER TABLE `fontis_useradminorders`
  MODIFY `admin_prodID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;

--
-- AUTO_INCREMENT for table `fontis_usercarts`
--
ALTER TABLE `fontis_usercarts`
  MODIFY `cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=601;

--
-- AUTO_INCREMENT for table `fontis_usercartscheckout`
--
ALTER TABLE `fontis_usercartscheckout`
  MODIFY `admin_cartID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=191;
...
--
ALTER TABLE `fontis_userhistorybreakdown`
  MODIFY `history_breakoutID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
