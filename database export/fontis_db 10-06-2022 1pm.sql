...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2022 at 07:25 AM
...
(128, 535, 16, 8, 40, '3 pack Fontis 1 liter Mineral Water', 'On-the-go refreshment', 1, '2131230978', '194', 'not delivered'),
(129, 536, 16, 6, 195, '3 pack Fontis 5 liter Mineral Water', 'If one is not enough, add more refreshing natural mineral water for quick thirst quencher and refreshment.', 2, '2131230976', '194', 'not delivered'),
(130, 537, 16, 2, 155, 'Fontis 5 Gallon Mineral Water(non-refill)', 'Refreshing natural mineral water in a round container best used for water dispensers.', 3, '2131230972', '194', 'not delivered'),
(131, 538, 16, 1, 35, 'Fontis 5 Gallon Mineral Water(refill)', 'Refreshing natural mineral water in a round container best used for water dispensers.', 1, '2131230972', '195', 'not delivered'),
(132, 539, 16, 18, 169, 'Fontis 24 ounce Stainless Steel Bottle', 'Get your own insulated bottle to store your favorite beverage for free on every ₱ 399 worth of purchase or get this item for ₱ 169.', 2, '2131230971', '195', 'not delivered'),
(133, 540, 15, 4, 75, 'Fontis 2.5 Gallon Mineral Water', 'Compact water container with faucet, good for carrying on picnics and outdoor activities.', 3, '2131230974', '196', 'not delivered'),
(134, 541, 15, 18, 169, 'Fontis 24 ounce Stainless Steel Bottle', 'Get your own insulated bottle to store your favorite beverage for free on every ₱ 399 worth of purchase or get this item for ₱ 169.', 1, '2131230971', '196', 'not delivered'),
(135, 542, 15, 1, 35, 'Fontis 5 Gallon Mineral Water(refill)', 'Refreshing natural mineral water in a round container best used for water dispensers.', 1, '2131230972', '196', 'not delivered'),
(136, 543, 15, 2, 155, 'Fontis 5 Gallon Mineral Water(non-refill)', 'Refreshing natural mineral water in a round container best used for water dispensers.', 1, '2131230972', '197', 'not delivered'),
(137, 544, 15, 17, 30, 'Fontis 16 ounce infused Water', 'A refreshing and healthy twist to your good old thirst quencher.(comes in different flavors: lime, strawberry, apple, kiwi, cucumber & peach)', 2, '2131230970', '197', 'not delivered'),
(138, 545, 15, 7, 15, 'Fontis 1 liter Mineral Water', 'On-the-go refreshment.', 3, '2131230977', '198', 'not delivered'),
(139, 546, 15, 15, 75, 'Fontis 5 liter Purified Water', 'Portable purified water container for quick thirst quencher and refreshment.', 2, '2131230968', '198', 'not delivered');
...
(194, 16, 895, '10-6-2022', 6, '2131165281', 'true'),
(195, 16, 373, '10-6-2022', 3, '2131165281', 'false'),
(196, 15, 429, '10-6-2022', 5, '2131165281', 'true'),
(197, 15, 215, '10-6-2022', 3, '2131165281', 'false'),
(198, 15, 195, '10-6-2022', 5, '2131165281', 'false');
...
(15, 'Legendary', '035c38b95750ab68cc7544f3f821e7f1', 'Charizard', 'Pokemon', '09653294781', 'Brgy. Concepcion San Pablo City Laguna', '11/25/1999', 'charizard6969@gmail.com', 'Unemployed', 'Single', ''),
(16, 'Ben', '035c38b95750ab68cc7544f3f821e7f1', 'Benedicto', 'Lucido Jr.', '09369733382', '3487 Gracia St. Pinagkaisahan Makati City Philippines', '11/20/2001', 'benedictlucido69@gmail.com', 'Employed', 'Married', '');
...
--
ALTER TABLE `fontis_useradminbreakdown`
  MODIFY `admin_breakdownID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=247;

--
-- AUTO_INCREMENT for table `fontis_useradminhistory`
--
ALTER TABLE `fontis_useradminhistory`
  MODIFY `admin_historyID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `fontis_useradminorders`
--
ALTER TABLE `fontis_useradminorders`
  MODIFY `admin_prodID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=150;

--
-- AUTO_INCREMENT for table `fontis_usercarts`
--
ALTER TABLE `fontis_usercarts`
  MODIFY `cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=547;

--
-- AUTO_INCREMENT for table `fontis_usercartscheckout`
--
ALTER TABLE `fontis_usercartscheckout`
  MODIFY `admin_cartID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;

--
-- AUTO_INCREMENT for table `fontis_userhistory`
--
ALTER TABLE `fontis_userhistory`
  MODIFY `prod_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=199;
