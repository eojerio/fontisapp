...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2022 at 05:25 AM
...
(53, 458, 11, 1, 35, 'Fontis 5 Gallon Mineral Water(refill)', 'Refreshing natural mineral water in a round container best used for water dispensers.', 1, '2131230973', '163', 'not delivered'),
(54, 459, 11, 2, 155, 'Fontis 5 Gallon Mineral Water(non-refill)', 'Refreshing natural mineral water in a round container best used for water dispensers.', 1, '2131230973', '163', 'not delivered'),
(55, 460, 11, 3, 149, 'Fontis 5 Gallon Mineral Water(Slim container)', 'Refreshing natural mineral water in a slim container with faucet for portability.', 1, '2131230974', '163', 'not delivered'),
(56, 461, 11, 18, 169, 'Fontis 24 ounce Stainless Steel Bottle', 'Get your own insulated bottle to store your favorite beverage for free on every ₱ 399 worth of purchase or get this item for ₱ 169.', 1, '2131230972', '164', 'not delivered'),
(57, 462, 11, 17, 30, 'Fontis 16 ounce infused Water', 'A refreshing and healthy twist to your good old thirst quencher.(comes in different flavors: lime, strawberry, apple, kiwi, cucumber & peach)', 1, '2131230971', '164', 'not delivered'),
(58, 463, 11, 16, 210, '3 pack Fontis 5 liter Purified Water', 'If one is not enough, add more refreshing purified water for quick thirst quencher and refreshment.', 1, '2131230970', '164', 'not delivered');
...
(163, 11, 339, '09-6-2022', 3, '2131165281', 'false'),
(164, 11, 409, '09-6-2022', 3, '2131165281', 'false');
...
--
ALTER TABLE `fontis_useradminbreakdown`
  MODIFY `admin_breakdownID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=166;

--
-- AUTO_INCREMENT for table `fontis_useradminorders`
--
ALTER TABLE `fontis_useradminorders`
  MODIFY `admin_prodID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;

--
-- AUTO_INCREMENT for table `fontis_usercarts`
--
ALTER TABLE `fontis_usercarts`
  MODIFY `cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=464;

--
-- AUTO_INCREMENT for table `fontis_usercartscheckout`
--
ALTER TABLE `fontis_usercartscheckout`
  MODIFY `admin_cartID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
